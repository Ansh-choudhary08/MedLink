...
export function HowItWorks() {
    return (
        <section className="py-24 bg-white-900 text-white relative overflow-hidden">
            {/* Background Elements */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-20">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-green-600 rounded-full blur-3xl mix-blend-screen animate-pulse" />
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative">
                    {/* Connecting Line */}
                    <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-green-700 dark:bg-slate-800 -translate-y-1/2 z-0" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="w-16 h-16 rounded-full bg-slate-800 border-4 border-slate-900 flex items-center justify-center mb-6 shadow-lg shadow-green-900/20 group hover:bg-green-600 transition-colors duration-300">
                                    <step.icon className="w-8 h-8 text-green-400 group-hover:text-white transition-colors" />
                                </div>
